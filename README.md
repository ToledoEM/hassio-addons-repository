...
| <img src="obsidian_syncserver_npm/icon.png" width="150" height="150" /> | [Obsidian Sync Server NPM](obsidian_syncserver_npm/README.md) | obsidian_syncserver_npm | 3.5.2-1 | Self-hosted Obsidian LiveSync backend on CouchDB, bundled with Nginx Proxy Manager for TLS and certificate management. |
