...
The vault database lives in `/config/obsidian-syncserver/data`, so it survives a reinstall and gets picked up by Home Assistant backups. NPM's own database and certificates live in `/data`.
